...
def read_and_preprocess_input(
    ...
    """
    Returns news article json files as data frame.
    Also applies pre-preprocessing steps specified in pipeline configuration.
    Uses <training> argument to toggle between <training_filename> &
    <inference_filename> configuration parameters.

    :param config:
        PipelineConfig
    :param training:
        Boolean to load training or inference data.

    :return:
        News articles as data frame
    """
    if training:
